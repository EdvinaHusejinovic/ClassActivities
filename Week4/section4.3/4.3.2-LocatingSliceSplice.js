...
console.log("First a:", arr.lastIndexOf("a"));
console.log("First b:", arr.lastIndexOf("b"));
console.log("First c:", arr.lastIndexOf("c"));
...
// use a while loop instead of a for loop because a while loop will
