...
const userSix = data.filter(user => user.userId === 6);
console.log(userSix);

// filter user 6 incomplete tasks
const userSixComplete = userSix.filter(user => user.complete === false);
console.log(userSixComplete);

// filter for tasks with a title less than 24 characters long
const shortTitle = data.filter(user => user.title.lenght < 24);
